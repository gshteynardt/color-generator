...
import type { ColorProps, HslColorProps } from '~/types/color';
import { getHue, hashFnv32a, normalizeHash } from './helpers';
...
const getHash = (seed: string) => {
    const hash =
        hashFnv32a(seed, 0x73_6f_6d_65) ^ hashFnv32a(seed, 0x64_6f_72_61);
...
export const getPersistentColor = ({
    seed,
    intensity = 'light',
    theme,
}: ColorProps) => {
